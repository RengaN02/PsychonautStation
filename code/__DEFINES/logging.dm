...
#define LOG_HALLUCINATION (1 << 23)
#define LOG_TRANSPORT (1 << 24)
#define LOG_NTSL (1 << 25)

//Individual logging panel pages
#define INDIVIDUAL_GAME_LOG (LOG_GAME)
#define INDIVIDUAL_ATTACK_LOG (LOG_ATTACK | LOG_VICTIM)
#define INDIVIDUAL_SAY_LOG (LOG_SAY | LOG_WHISPER | LOG_DSAY | LOG_SPEECH_INDICATORS | LOG_HALLUCINATION)
#define INDIVIDUAL_HALLUCINATION_LOG (LOG_HALLUCINATION)
