...
/obj/item/temperature_pack
	...
	icon = 'code/modules/pain/icons/obj/pain_items.dmi'
	lefthand_file = 'code/modules/pain/icons/mob/inhands/pain_items_lhand.dmi'
	righthand_file = 'code/modules/pain/icons/mob/inhands/pain_items_rhand.dmi'
...
/obj/item/storage/pill_bottle/painkillers
	...
	icon = 'code/modules/pain/icons/obj/chemical.dmi'
...
/obj/item/storage/pill_bottle/painkillers/PopulateExtra()
	for(var/i in 1 to 3)
...
/obj/item/reagent_containers/hypospray/medipen/survival/painkiller
	...
	icon = 'code/modules/pain/icons/obj/syringe.dmi'
...
/obj/item/shock_blanket
	...
	icon = 'code/modules/pain/icons/obj/pain_items.dmi'
	worn_icon = 'code/modules/pain/icons/mob/pain_items.dmi'
	lefthand_file = 'code/modules/pain/icons/mob/inhands/pain_items_lhand.dmi'
	righthand_file = 'code/modules/pain/icons/mob/inhands/pain_items_rhand.dmi'
...
/obj/item/shock_blanket/proc/enable_protection(mob/living/source)
	if(istype(source) && !(datum_flags & DF_ISPROCESSING))
		...
		if(source.bodytemperature > BODYTEMP_NORMAL)
			temp_change = "colder"
...
/obj/item/shock_blanket/process(seconds_per_tick)
	...
	if(wearer.bodytemperature < BODYTEMP_NORMAL)
		wearer.adjust_bodytemperature(0.25 * seconds_per_tick, max_temp = BODYTEMP_NORMAL)
	else if(wearer.bodytemperature > BODYTEMP_NORMAL)
		wearer.adjust_bodytemperature(-0.25 * seconds_per_tick, min_temp = BODYTEMP_NORMAL)
...
/obj/item/storage/medkit/advanced/PopulateContents()
	...
	var/static/list/items_inside = list(
		...
		/obj/item/storage/pill_bottle/aspirin_para_coffee = 1,
